...
export declare enum NutritionCategory {
    ...
    SCHEDULER = 8,
    /**
     * UI - App may appear in subreddit, post, and comment menu entries, and custom posts.
    ...
    PAYMENTS = 12,
    /**
     * CUSTOM_POST - App can create a custom experience.
     * Note: CUSTOM_POST is a subset of UI: if CUSTOM_POST is set then UI is set also.
     */
    CUSTOM_POST = 13,
...
export type GetNutritionByNameVersionRequest = {
    /** App slug / ID. Eg, comment-nuke. */
    name: string;
    /** App version. Eg, 1.2.3 or 1.2.3.4. Defaults to latest. */
    version?: string | undefined;
};
export type MultipleNutritionCategories = {
