...
import { computeClusterFromJSON, computeClusterToJSON } from "../app/info/compute_cluster.js";
...
export const InstallationUpdateRequest = {
    ...
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.computeCluster !== undefined) {
            writer.uint32(72).int32(message.computeCluster);
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 9:
                    ...
                    message.computeCluster = reader.int32();
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON(object) {
        return {
            ...
            computeCluster: isSet(object.computeCluster) ? computeClusterFromJSON(object.computeCluster) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.computeCluster !== undefined) {
            obj.computeCluster = computeClusterToJSON(message.computeCluster);
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.computeCluster = object.computeCluster ?? undefined;
        return message;
    },
};
...
export const InstallationInfo = {
    ...
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.computeCluster !== 0) {
            writer.uint32(96).int32(message.computeCluster);
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        return {
            ...
            computeCluster: isSet(object.computeCluster) ? computeClusterFromJSON(object.computeCluster) : 0,
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    fromPartial(object) {
        ...
        message.computeCluster = object.computeCluster ?? 0;
        return message;
    },
};
messageTypeRegistry.set(InstallationInfo.$type, InstallationInfo);
function createBaseInstallationLocationInfo() {
    return { id: "", name: "", type: 0, icon: undefined, isNsfw: false, isUnavailable: false, isModerator: false };
}
export const InstallationLocationInfo = {
    ...
    encode(message, writer = _m0.Writer.create()) {
        ...
        if (message.isModerator !== false) {
            writer.uint32(56).bool(message.isModerator);
        }
        return writer;
    },
    decode(input, length) {
