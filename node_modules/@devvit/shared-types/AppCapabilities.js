 ...
 */
export function appCapabilitiesFromActor({ actorTypes, actorPlugins, hasWebView, }) {
    const names = [
...
function appCapabilitiesFromFullNames(fullNames, hasWebview) {
 ...
 */
function appCapabilityFromFullName(fullName) {
    switch (fullName) {
